...
def ADABoost_btn(req):
    ...
    messages.success(req, 'Algorithm executed Successfully')
    return render(req, 'admin/admin-adaboost-algorithm.html',{'i': data})
...
def cgraph(req):
    ...
    h = details7.Accuracy
    return render(req, 'admin/admin-graph-analysis.html', {'xg':a,'ada':b,'knn':c,'sxm':d,'dt':e,'ann':f,'log':g, 'ran':h})
